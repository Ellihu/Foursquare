...
namespace Presentacion
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IUserLoggedService, WebUserLoggedService>();
            ...
            services.Configure<FoursquareModel>(Configuration.GetSection("FoursquareOptions"));
            services.AddScoped<IFavoritosService, FavoritosService>();
            services.AddScoped<IFoursquarePlacesService, FoursquarePlacesService>();
        }
